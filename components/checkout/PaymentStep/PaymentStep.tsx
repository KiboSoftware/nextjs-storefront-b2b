...
//   const handlePaymentTypeSelection = (event: ChangeEvent<HTMLInputElement>) => {
//     setIsAddingNewPayment(true)
//     setSelectedPaymentTypeRadio(event.target.value)
...
//         if (selectedPaymentTypeRadio === PaymentType.CREDITCARD) await saveCardDataToOrder()
//         if (selectedPaymentTypeRadio === PaymentType.PURCHASEORDER)
//           await savePurchaseOrderDataToOrder()
//       } else {
...
//     savedPaymentBillingDetails?.length && !isAddingNewPayment

//   const shouldShowPreviouslySavedPaymentsForPurchaseOrder =
//     savedPaymentBillingDetailsForPurchaseOrder?.length && !isAddingNewPayment
...
//     if (isAddingNewPayment && selectedPaymentTypeRadio === PaymentType.PURCHASEORDER) {
//       return true
//     }
//     return false
//   }
...
//     if (isAddingNewPayment && selectedPaymentTypeRadio === PaymentType.CREDITCARD) {
//       return true
//     }
...
//     if (isAddingNewPayment && Boolean(selectedPaymentTypeRadio)) {
//       return true
//     }
//     return false
//   }
...
//       const paymentsWithNewStatus = orderGetters.getSelectedPaymentType(
//         checkout,
...
//       isSameAsShipping
//     )
//     const paymentsPurchaseOrderWithNewStatus = orderGetters.getSelectedPaymentType(
//       checkout,
...
//           paymentType: selectedPaymentTypeRadio,
...
//     const checkoutPaymentWithNewStatus = orderGetters.getSelectedPaymentType(
//       checkout,
//       PaymentType.CREDITCARD
//     )
...
//       setSelectedPaymentTypeRadio(PaymentType.CREDITCARD)
//     }
//   }
...
//       setSelectedPaymentTypeRadio(PaymentType.PURCHASEORDER)
//     }
//   }
...
//     if (
//       (isCustomerCardsSuccess &&
//         isCustomerContactsSuccess &&
//         selectedPaymentTypeRadio === PaymentType.CREDITCARD) ||
//       !isAuthenticated
//     ) {
...
//   }, [isCustomerCardsSuccess, isCustomerContactsSuccess, checkout, selectedPaymentTypeRadio])
...
//       } else {
//         if (selectedPaymentTypeRadio === PaymentType.PURCHASEORDER) savePurchaseOrderDataToOrder()
//         if (selectedPaymentTypeRadio === PaymentType.CREDITCARD) saveCardDataToOrder()
//       }
//     }
//     // eslint-disable-next-line react-hooks/exhaustive-deps
//   }, [stepStatus])
...
//           >
//             {paymentTypes.map((paymentMethod: PaymentMethod) => {
//               return (
...
//                   />
//                   {paymentMethod.id === selectedPaymentTypeRadio ? (
...
//                                     savedPaymentBillingDetailsForPurchaseOrder?.[0]
//                                       ?.billingAddressInfo?.contact.address as CrAddress
//                                   )
//                                 )}
...
//                           purchaseOrderPaymentTerms={purchaseOrderPaymentTerms as CustomerPurchaseOrderPaymentTerm[]}
...
//       {shouldShowPreviouslySavedPaymentsForPurchaseOrder || shouldShowPreviouslySavedPayments ? (
//         <Button
//           variant="contained"
//           color="inherit"
