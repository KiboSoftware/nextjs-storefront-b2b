...
const getProductDetails = (product: ProductCustom, pdpProductPrice?: ProductPrice, pdpProductPriceRange?: any) => {
  ...
  return {
    ...
    productPriceRange: pdpProductPriceRange ? getPriceRange(pdpProductPriceRange) : getPriceRange(product),
